...
// import translations from './helpers/translations.js';
// import colors from './helpers/colors.js';
// import { OutfitContext } from './helpers/OutfitContext.js';
...
//   const [refreshOutfits, setRefreshOutfits] = useState(null);

//   return (
//     <OutfitContext.Provider value={{ refreshOutfits, setRefreshOutfits }}>
//       <NavigationContainer>
//         <Tab.Navigator
//           screenOptions={({ route }) => ({
//             tabBarIcon: ({ focused, color, size }) => {
